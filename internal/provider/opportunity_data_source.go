...
var _ datasource.DataSource = &OpportunityDataSource{}
var _ datasource.DataSourceWithConfigure = &OpportunityDataSource{}

func NewOpportunityDataSource() datasource.DataSource {
	return &OpportunityDataSource{}
}

// OpportunityDataSource is the data source implementation.
type OpportunityDataSource struct {
	client *sdk.SDK
}
...
func (r *OpportunityDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_opportunity"
}

// Schema defines the schema for the data source.
func (r *OpportunityDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Opportunity DataSource",
...
func (r *OpportunityDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *OpportunityDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *OpportunityDataSourceModel
